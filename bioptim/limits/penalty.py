...
class PenaltyFunctionAbstract:
    ...
    class Functions:
        ...
        def minimize_explicit_rigid_contact_forces(
            ...
            if (
                ContactType.RIGID_IMPLICIT in controller.get_nlp.model.contact_types
                or ContactType.SOFT_IMPLICIT in controller.get_nlp.model.contact_types
                or ContactType.SOFT_EXPLICIT in controller.get_nlp.model.contact_types
            ):
                raise RuntimeError(
            ...
            if ContactType.RIGID_EXPLICIT in controller.get_nlp.model.contact_types:
