...
class Solution:
    ...
    solver_state: Any
        Opaque solver-specific state that can be reused for an exact warm start
    ...
    def from_dict(cls, ocp: "OptimalControlProgram", sol: AnyDict):
        ...
        is_casadi_nlp = sol["solver"] in (
            SolverType.IPOPT.value,
            SolverType.FATROP.value,
            SolverType.MADNLP.value,
        )
        ...
        return cls(
            ...
            solver_state=sol.get("solver_state"),
        )
    ...
    def copy(self, skip_data: Bool = False) -> "Solution":
        ...
        new.solver_state = deepcopy(self.solver_state)
